              ...
              <TerminalCommand
                commands={[
                  ...
                  },
                  {
                    ...
                    output: 'export EXPERIENCE="2+ years"',
                    delay: 1500,
                  },
                ]}
                autoStart={isInView}
        ...
        <div className="hidden md:grid md:grid-cols-[3fr_2fr] gap-8 md:gap-12 items-center mb-20 md:mb-32">
          ...
          >
            <p className="text-sm sm:text-base md:text-lg text-[#4a4a4a] leading-relaxed max-w-3xl mx-auto md:mx-0">
              Full Stack Engineer with <span className="text-[#008b8b] font-semibold">2+ years</span> of experience building scalable web applications. Expert in TypeScript, Next.js, Node.js, system design, and cloud deployment.
            </p>
        ...
        <div className="md:hidden flex flex-col items-center gap-6 mb-12">
          ...
          >
            <p className="text-sm text-[#4a4a4a] leading-relaxed">
              Full Stack Engineer with <span className="text-[#008b8b] font-semibold">2+ years</span> of experience building scalable web applications. Expert in TypeScript, Next.js, and Node.js.
            </p>
